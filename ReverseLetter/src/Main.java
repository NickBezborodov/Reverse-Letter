 public class Main {
     ...
     public static void main(String[] args) {
         ...
         String result = reverseOnlyLetters(str1); // создал статический метод, в него передается строка
         System.out.println(result); // результат метода сохраняется в переменную result и выводит ее
     }
     public static String reverseOnlyLetters(String str){ //объявляю метод, принимает строку str
